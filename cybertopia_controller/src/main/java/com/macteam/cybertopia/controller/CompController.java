...
public class CompController {
    ...
    public String comp(Model model, @RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "12") int size,@RequestParam(defaultValue = "") String selectedType, @RequestParam(defaultValue = "") String keywords) {
